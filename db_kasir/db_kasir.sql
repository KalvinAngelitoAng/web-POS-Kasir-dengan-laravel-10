...
--
-- Host: localhost    Database: db_kasir
-- ------------------------------------------------------
...
CREATE TABLE `members` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `members_idmember_unique` (`idmember`)
...
CREATE TABLE `tbl_transaksi` (
  ...
  `uang_pembeli` decimal(15,2) NOT NULL,
  `kembalian` decimal(15,2) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `tbl_transaksi_no_transaksi_unique` (`no_transaksi`)
...
CREATE TABLE `users` (
  ...
  `role` enum('admin','kasir') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- Dump completed on 2024-12-23 22:46:16
